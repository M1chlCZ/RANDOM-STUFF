...
apt-get -qq -y install build-essential libtool autotools-dev automake pkg-config libssl-dev libevent-dev bsdmainutils libboost-all-dev libzmq3-dev libminizip-dev
add-apt-repository ppa:bitcoin/bitcoin && apt-get update && -qq pt-get -y install libdb4.8-dev libdb4.8++-dev -y
